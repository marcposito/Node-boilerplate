...
import IDomainModelValidator from "./IDomainModelValidator";
...
abstract class Validator implements IDomainModelValidator<DTO> {
  ...
  getErrors(): Array<IValidationError> {
    return this.errors.reduce((messages: Array<IValidationError>, error: ValidationErrorItem): Array<IValidationError> => {
